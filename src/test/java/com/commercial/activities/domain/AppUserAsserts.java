...
public class AppUserAsserts {
    ...
    public static void assertAppUserUpdatableFieldsEquals(AppUser expected, AppUser actual) {
        assertThat(actual)
            ...
            .satisfies(a -> assertThat(a.getDisabled()).as("check disabled").isEqualTo(expected.getDisabled()))
            .satisfies(a -> assertThat(a.getDisabledDate()).as("check disabledDate").isEqualTo(expected.getDisabledDate()));
    }
