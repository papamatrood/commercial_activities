...
import static com.commercial.activities.domain.CompanyAsserts.*;
...
class CompanyResourceIT {
    ...
    private static final Instant UPDATED_CREATION_DATE = Instant.ofEpochMilli(1784236791515L);

    private static final CompanyStatusEnum DEFAULT_STATUS = CompanyStatusEnum.ACTIVE;
    private static final CompanyStatusEnum UPDATED_STATUS = CompanyStatusEnum.BLOCKED;
    ...
    public static Company createEntity() {
        return new Company().name(DEFAULT_NAME).location(DEFAULT_LOCATION).creationDate(DEFAULT_CREATION_DATE).status(DEFAULT_STATUS);
    }
    ...
    public static Company createUpdatedEntity() {
        return new Company().name(UPDATED_NAME).location(UPDATED_LOCATION).creationDate(UPDATED_CREATION_DATE).status(UPDATED_STATUS);
    }
    ...
    void getAllCompaniesByLocationIsEqualToSomething() throws Exception {
        ...
        // Get all the companyList where location equals to
        defaultCompanyFiltering("location.equals=" + DEFAULT_LOCATION, "location.equals=" + UPDATED_LOCATION);
    }
    ...
    void getAllCompaniesByLocationIsInShouldWork() throws Exception {
        ...
        // Get all the companyList where location in
        defaultCompanyFiltering("location.in=" + DEFAULT_LOCATION + "," + UPDATED_LOCATION, "location.in=" + UPDATED_LOCATION);
    }
    ...
    void getAllCompaniesByLocationIsNullOrNotNull() throws Exception {
        ...
        defaultCompanyFiltering("location.specified=true", "location.specified=false");
    }
    ...
    void getAllCompaniesByLocationContainsSomething() throws Exception {
        ...
        // Get all the companyList where location contains
        defaultCompanyFiltering("location.contains=" + DEFAULT_LOCATION, "location.contains=" + UPDATED_LOCATION);
    }
    ...
    void getAllCompaniesByLocationNotContainsSomething() throws Exception {
        ...
        // Get all the companyList where location does not contain
        defaultCompanyFiltering("location.doesNotContain=" + UPDATED_LOCATION, "location.doesNotContain=" + DEFAULT_LOCATION);
    }

    @Test
    @Transactional
    void getAllCompaniesByCreationDateIsEqualToSomething() throws Exception {
        // Initialize the database
        insertedCompany = companyRepository.saveAndFlush(company);

        // Get all the companyList where creationDate equals to
        defaultCompanyFiltering("creationDate.equals=" + DEFAULT_CREATION_DATE, "creationDate.equals=" + UPDATED_CREATION_DATE);
    }

    @Test
    @Transactional
    void getAllCompaniesByCreationDateIsInShouldWork() throws Exception {
        // Initialize the database
        insertedCompany = companyRepository.saveAndFlush(company);

        // Get all the companyList where creationDate in
    ...
    @Test
    @Transactional
    void getAllCompaniesByCreationDateIsNullOrNotNull() throws Exception {
        // Initialize the database
        insertedCompany = companyRepository.saveAndFlush(company);

        // Get all the companyList where creationDate is not null
        defaultCompanyFiltering("creationDate.specified=true", "creationDate.specified=false");
    }
    ...
    void getAllCompaniesByStatusIsEqualToSomething() throws Exception {
        ...
        // Get all the companyList where status equals to
        defaultCompanyFiltering("status.equals=" + DEFAULT_STATUS, "status.equals=" + UPDATED_STATUS);
    }
    ...
    void getAllCompaniesByStatusIsInShouldWork() throws Exception {
        ...
        // Get all the companyList where status in
        defaultCompanyFiltering("status.in=" + DEFAULT_STATUS + "," + UPDATED_STATUS, "status.in=" + UPDATED_STATUS);
    }
    ...
    void getAllCompaniesByStatusIsNullOrNotNull() throws Exception {
        ...
        defaultCompanyFiltering("status.specified=true", "status.specified=false");
    }
    ...
    void putExistingCompany() throws Exception {
        ...
        updatedCompany.name(UPDATED_NAME).location(UPDATED_LOCATION).creationDate(UPDATED_CREATION_DATE).status(UPDATED_STATUS);
    ...
    void fullUpdateCompanyWithPatch() throws Exception {
        ...
        partialUpdatedCompany.name(UPDATED_NAME).location(UPDATED_LOCATION).creationDate(UPDATED_CREATION_DATE).status(UPDATED_STATUS);
