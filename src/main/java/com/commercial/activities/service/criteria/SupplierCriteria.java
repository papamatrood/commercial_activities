...
/**
 * Criteria class for the {@link com.commercial.activities.domain.Supplier} entity. This class is used
 * in {@link com.commercial.activities.web.rest.SupplierResource} to receive all the possible filtering options from
...
public class SupplierCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, contact, distinct);
    }
