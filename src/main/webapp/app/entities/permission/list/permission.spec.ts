...
describe('Permission Management Component', () => {
  ...
  it('should call load all on init', async () => {
    ...
    req.flush([{ id: 19932 }], { headers: { link: '<http://localhost/api/foo?page=1&size=20>; rel="next"' } });
  ...
  describe('trackId', () => {
    it('should forward to permissionService', () => {
      ...
      vitest.spyOn(service, 'getPermissionIdentifier');
  ...
  it('should calculate the sort attribute for an id', () => {
    ...
    // THEN
    expect(service.permissionsParams()).toMatchObject(expect.objectContaining({ sort: ['id,desc'] }));
  });
