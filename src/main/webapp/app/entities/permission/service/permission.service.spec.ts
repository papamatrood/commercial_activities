...
describe('Permission Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Permission', () => {
      ...
      service.create(permission).subscribe(resp => (expectedResult = resp));
    ...
    it('should update a Permission', () => {
      ...
      service.update(permission).subscribe(resp => (expectedResult = resp));
    ...
    describe('addPermissionToCollectionIfMissing', () => {
      it('should add a Permission to an empty array', () => {
        ...
        expect(expectedResult).toEqual([permission]);
      });
      ...
      it('should accept varargs', () => {
        ...
        expect(expectedResult).toEqual([permission, permission2]);
      });
