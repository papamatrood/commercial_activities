...
import { CompanySubscriptionDeleteDialog } from './company-subscription-delete-dialog';

describe('CompanySubscription Management Delete Component', () => {
  let comp: CompanySubscriptionDeleteDialog;
  let fixture: ComponentFixture<CompanySubscriptionDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(CompanySubscriptionDeleteDialog);
