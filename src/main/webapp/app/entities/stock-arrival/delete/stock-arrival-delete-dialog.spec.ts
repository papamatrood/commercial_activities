...
import { StockArrivalDeleteDialog } from './stock-arrival-delete-dialog';

describe('StockArrival Management Delete Component', () => {
  let comp: StockArrivalDeleteDialog;
  let fixture: ComponentFixture<StockArrivalDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(StockArrivalDeleteDialog);
