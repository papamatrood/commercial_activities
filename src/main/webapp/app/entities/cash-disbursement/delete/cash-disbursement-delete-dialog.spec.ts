...
import { CashDisbursementDeleteDialog } from './cash-disbursement-delete-dialog';

describe('CashDisbursement Management Delete Component', () => {
  let comp: CashDisbursementDeleteDialog;
  let fixture: ComponentFixture<CashDisbursementDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(CashDisbursementDeleteDialog);
