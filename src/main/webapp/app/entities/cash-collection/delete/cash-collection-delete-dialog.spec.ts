...
import { CashCollectionDeleteDialog } from './cash-collection-delete-dialog';

describe('CashCollection Management Delete Component', () => {
  let comp: CashCollectionDeleteDialog;
  let fixture: ComponentFixture<CashCollectionDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(CashCollectionDeleteDialog);
