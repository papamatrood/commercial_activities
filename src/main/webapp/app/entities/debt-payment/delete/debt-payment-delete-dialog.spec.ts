...
describe('DebtPayment Management Delete Component', () => {
  let comp: DebtPaymentDeleteDialog;
  let fixture: ComponentFixture<DebtPaymentDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(DebtPaymentDeleteDialog);
