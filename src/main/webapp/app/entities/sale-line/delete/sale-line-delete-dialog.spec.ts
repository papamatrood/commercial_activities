...
import { SaleLineDeleteDialog } from './sale-line-delete-dialog';

describe('SaleLine Management Delete Component', () => {
  let comp: SaleLineDeleteDialog;
  let fixture: ComponentFixture<SaleLineDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(SaleLineDeleteDialog);
